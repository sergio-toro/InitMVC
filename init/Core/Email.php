...
class Core_Email {
    ...
    public function clear($clear_attachments = FALSE) {
        ...
        $this->_setHeader('Date', $this->_set_date());
    ...
    public function bcc($bcc, $limit = '') {
        ...
        if (($this->_getProtocol() == "smtp") 
            OR ($this->bcc_batch_mode && count($bcc)>$this->bcc_batch_size)) {
            $this->_bcc_array = $bcc;
        }
        else {
     ...
     * @return  string
     */
    protected function _getProtocol($return = TRUE) {
     ...
     * @return  str
     */
    protected function _prepQEncoding($str, $from = FALSE)
    {
    ...
    protected function _spool_email()
    {
        ...
        $this->_set_error_message('lang:email_sent', $this->_getProtocol());
        return TRUE;
    }
    ...
    protected function _send_with_smtp()
    {
        ...
        $this->_send_command('from', $this->cleanEmail($this->_headers['From']));
    ...
    public function print_debugger()
    {
        ...
        $msg .= "<br />BODY:<pre>".$this->_header_str."\n".htmlspecialchars($this->_subject)."\n".htmlspecialchars($this->_finalbody).'</pre>';
        return $msg;
    }
